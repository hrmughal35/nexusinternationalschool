...
export function HeroSection() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-white px-4 pt-28 pb-10 sm:px-6 lg:px-10">
      <div className="relative mx-auto grid max-w-7xl items-start gap-8 lg:min-h-[82vh] lg:grid-cols-[0.92fr_1.08fr]">
        ...
        <div className="order-1 relative min-h-[22rem] lg:order-2 lg:min-h-[38rem]">
          <div className="relative mt-6 mx-auto h-[26rem] w-full max-w-[26rem] overflow-hidden sm:h-[30rem] sm:max-w-[30rem] lg:mt-10 lg:mr-0 lg:h-[34rem] lg:max-w-[44rem]">
            <Image
              src="/nexus-hero-avatar-cleaned.png"
              alt="Premium illustrated Nexus student"
              fill
              priority
              className="z-20 object-contain object-bottom drop-shadow-[0_24px_35px_rgba(15,23,42,0.12)] scale-[1.22] lg:scale-[1.34]"
              sizes="(max-width: 640px) 18rem, (max-width: 1024px) 26rem, 36rem"
            />
          </div>
        </div>
      </div>
